...
test_that("get error if API key is null", {
  ...
  expect_error(pp_query('115/bills/hr21.json',API = 'congress', version='v1', myAPI_Key = NULL))
  
  expect_error(pp_query('2018/races/MI/house/11.json', API='campaign-finance',version='v1', myAPI_Key = NULL))

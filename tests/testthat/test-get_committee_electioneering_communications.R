...
test_that("testing errors", {
  ...
  expect_warning(expect_error(get_committee_electioneering_communications(1995, 'C30002034'), 'Incorrect cycle'), "Cycle should be four-digit year largest than 1996")
